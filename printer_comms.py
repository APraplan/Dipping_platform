...
class printer:
    ...
    def move_home(self, printMsg=False):
    ...
    def move_axis_incremental(self, x = None, y = None, z = None, f = None, printMsg = False):
        command = "G0"
    ...
    def pwm_duty_cycle(self, d = None, printMsg=False):
        if d is None:
            self.send_gcode("M07", wait_until_completion=False, printMsg=printMsg)
        else:
            command = "M106 S" + str(d)
